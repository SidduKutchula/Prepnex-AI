...
const faqItems = [
    {
        q: 'How accurate is Interview AI?',
    ...
    },
    {
        ...
        a: 'Absolutely. Paste any job posting — engineering, product, data science, design, or management — and the AI will adapt its analysis and question generation accordingly.'
    },
    {
    ...
    },
    {
        ...
        a: 'The AI reads both the job description and your profile together, identifies skill gaps, and generates questions an experienced interviewer at that company type would realistically ask — including the hidden intention behind each question.'
    },
    {
...
const testimonials = [
    {
        ...
        avatar: 'PS',
        rating: 5,
        text: 'I used Interview AI for two weeks before my Google loop. The system design questions were scarily accurate. Passed all four rounds — my interviewer literally asked about consistent hashing which was in my roadmap.'
    },
    {
        name: 'Marcus Chen',
        role: 'SWE II → Staff Engineer at Meta',
        avatar: 'MC',
        rating: 5,
    ...
    {
        name: 'Aisha Williams',
        role: 'ML Researcher → Stripe',
        avatar: 'AW',
        rating: 5,
        text: 'Most prep tools are too generic. Interview AI read my actual resume against the Stripe JD and built a roadmap that felt like it was made by someone who knew both sides of the table.'
    }
]
        ...
        <div className="intro-page">
            ...
            <section className="hero-section">
                <div className="hero-container">
                    ...
                    >
                        Paste the job description. Upload your resume. Get a personalized preparation roadmap, tailored mock questions, ATS score, and behavioral checklists — ready in under 30 seconds.
                    </motion.p>
                    ...
                    <div className="mock-dashboard glass-card">
                        ...
                        <div className="mock-dash__body">
                            ...
                            <div className="mock-roadmap">
                                ...
                                {['Day 1 · React Fiber & Render Reconciliation', 'Day 2 · System Design: Distributed Cache', 'Day 3 · Node.js Event Loop & Clustering'].map((item) => (
                ...
                <div className="section__inner">
                    <div className="showcase-split showcase-split--reverse">
                        ...
                        >
                            ...
                            <p className="showcase-body">The AI reads the full job description — not just keywords — to understand seniority expectations, team context, and the underlying technical bar. Your preparation is calibrated to what the hiring manager actually needs.</p>
                            <ul className="showcase-list">
                ...
                <div className="section__inner">
                    ...
                    >
                        {[
                            ...
                            { icon: <Map size={22} />, color: 'green', title: 'Day-by-Day Roadmap', body: 'A structured, chronological study plan with specific daily tasks — no more aimless grinding without direction.' },
                            ...
                            { icon: <Zap size={22} />, color: 'purple', title: 'Interview Intention Reveal', body: 'Understand the "why" behind each question — what skill, behavior, or red flag the interviewer is actually probing for.' }
                        ].map((f, i) => (
                            ...
                            <div className="showcase-card glass-card">
                                ...
                                <div className="coach-preview">
                                    ...
                                    <div className="coach-bubble coach-bubble--user">
                                        <p>I'd start with the core requirements — URL generation, storage, and redirect latency...</p>
                                    </div>
                                    <div className="coach-bubble coach-bubble--ai">
                                        <div className="coach-bubble__avatar"><Bot size={14} /></div>
                            ...
                            <div className="showcase-card glass-card">
                                ...
                                <div className="analytics-preview">
                                    <div className="analytics-stat">
                                        <span className="analytics-stat__value">3.2×</span>
            ...
            <section className="section testimonials-section">
                <div className="section__inner">
                    <div className="section-header">
                        ...
                        <p className="section-subtitle">Real results from candidates who used Interview AI before their final rounds.</p>
                    </div>
            ...
            <section className="cta-banner">
                <div className="cta-banner__inner">
                    ...
                    <p>Equip yourself with a personalized roadmap, mock questions, and an ATS-ready resume — all in one place.</p>
            ...
            <footer className="intro-footer">
                <div className="intro-footer__inner">
                    <div className="intro-footer__brand">
                        ...
                        <span className="footer-brand-name">Interview AI</span>
                    </div>
                    <p className="intro-footer__copy">© {new Date().getFullYear()} Interview AI. Built for serious candidates.</p>
